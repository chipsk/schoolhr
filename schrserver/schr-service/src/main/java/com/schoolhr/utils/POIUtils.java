...
//
//    public static ResponseEntity<byte[]> employee2Excel(List<EmpInfo> list) {
//        //1. 创建一个 Excel 文档
...
//            EmpInfo emp = list.get(i);
//            HSSFRow row = sheet.createRow(i + 1);
//            row.createCell(0).setCellValue(emp.getId());
//            row.createCell(1).setCellValue(emp.getUsername());
//            row.createCell(2).setCellValue(emp.getUserID());
...
//            row.createCell(12).setCellValue(emp.getDepartment().getUsername());
//
...
//     * @return
//     */
//    public static List<EmpInfo> excel2Employee(MultipartFile file, List<Department> allDepartments, List<Position> allPositions) {
